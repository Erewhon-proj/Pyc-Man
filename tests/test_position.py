...
class TestPosition:
    ...
    @pytest.mark.parametrize("x, y, expected_grid", [
        (0, 0, (0, 0)),                                  # Origin
        (TILE_SIZE, TILE_SIZE * 2, (1, 2)),              # Exact boundary
        (TILE_SIZE * 1.5, TILE_SIZE * 2.7, (1, 2)),      # Internal offset
        (TILE_SIZE * 5, TILE_SIZE * 10, (5, 10))         # Large numbers
    ])
    ...
    @pytest.mark.parametrize("x, y, expected_center", [
        (0, 0, (TILE_SIZE / 2, TILE_SIZE / 2)),
        (100, 100, (100 + TILE_SIZE / 2, 100 + TILE_SIZE / 2)),
        (TILE_SIZE, TILE_SIZE * 2, (TILE_SIZE + TILE_SIZE / 2, TILE_SIZE * 2 + TILE_SIZE / 2))
    ])
    ...
    @pytest.mark.parametrize("pos1, pos2, expected_distance", [
        ...
        # Diagonal (3-4-5 triangle) - Centers: (15, 15) and (45, 55). Delta: 30, 40. Distance: 50.
